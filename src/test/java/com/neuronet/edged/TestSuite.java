...
import static com.neuronet.util.FunctionType.BIPOLAR;
...
//            check(exp, act);
    ...
    public void sinNetGenerator() throws IOException {
        ...
        Map.Entry<Float, INet> bestNet = nets.firstEntry();
        System.out.println("BEST: " + bestNet.getKey());
        System.out.println(Util.summary(bestNet.getValue()));
    ...
    private static INet createSinNet() {
        final INet net = new Net(1, (float) Math.PI * 2,
//                new Configuration(
